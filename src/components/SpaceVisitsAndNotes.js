      ...
      <section className='space-y-4'>
        ...
        <div className='flex flex-wrap items-center gap-4'>
          <button
            type='button'
            onClick={toggleVisit}
            className={`nav-action h-9 rounded-full px-5 text-xs uppercase tracking-[0.28em] ${
        ...
        <div className='space-y-4 p-2'>
          ...
          <div className='flex flex-wrap gap-3'>
            <button
              ...
              className='nav-action nav-cta h-10 px-6 text-xs uppercase tracking-[0.28em] disabled:cursor-not-allowed disabled:opacity-60'>
              {savingNote ? 'Saving…' : 'Save note'}
            </button>
            <button
              type='button'
              onClick={() => setNoteModalOpen(false)}
              className='nav-action h-10 px-6 text-xs uppercase tracking-[0.28em]'>
              Cancel
            </button>
            {myNote && (
              <button
                ...
                onClick={deleteNote}
                disabled={savingNote}
                className='nav-action h-10 px-6 text-xs uppercase tracking-[0.28em] text-red-400 disabled:cursor-not-allowed disabled:opacity-60'>
                Remove note
              </button>
            )}
          </div>
